    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3">
        <button
          ...
          class="px-4 py-2.5 rounded-xl bg-bomberos-red hover:bg-bomberos-red-hover text-white text-xs font-bold shadow-lg shadow-red-950/40 transition-all flex items-center gap-2 uppercase tracking-wider"
        >
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
          </svg>
          <span>Registrar Traslado / Movimiento</span>
        </button>
      </div>
    </div>
      ...
      <div class="bg-bomberos-surface border border-bomberos-border rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl p-6 space-y-4">
        ...
        <form @submit.prevent="handleSubmitMovimiento" class="space-y-3">
          ...
          <div class="pt-3 border-t border-bomberos-border flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              class="px-5 py-2 rounded-xl bg-bomberos-red hover:bg-bomberos-red-hover text-white text-xs font-bold shadow-lg uppercase tracking-wide"
            >
              Ejecutar Traslado
            </button>
          </div>
